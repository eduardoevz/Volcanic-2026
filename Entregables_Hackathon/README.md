<div align="center">
  ...
  # Cora
  ### README técnico — Entregable "Desarrollo" (Hackathon Nicaragua 2026)
...
> Este documento corresponde al ítem **"Desarrollo — README técnico"** de la rúbrica del hackathon:
> descripción general, tecnologías utilizadas, instalación básica y ejecución del sistema.
...
├─ docs/                 # Documentación real del proceso
├─ entregables/          # Documentos exportados (README, estudio de BD, etc.)
├─ Entregables_Hackathon/ # Entregables oficiales según la rúbrica del hackathon
└─ releases/             # APKs de release listos para instalar
```

## 3. Instalación básica y ejecución del sistema
...
5. **Probar sin compilar**: hay un APK de release firmado en [`releases/`](../releases/), instalable
   directamente en un dispositivo Android (sideload) — no requiere Metro, cable USB, ni computadora
   corriendo. También publicado como
   [GitHub Release](https://github.com/eduardoevz/Volcanic-2026/releases) para descarga directa.
...
continua en GitHub Actions (lint + typecheck + cobertura en cada PR). Detalle completo en
...
- [`docs/PROGRESO.md`](../docs/PROGRESO.md) — registro completo, fase por fase
